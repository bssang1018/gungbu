...
public class TeacherController {
    ...
    public ResponseEntity<TeacherDto> teacherJoin(@RequestBody TeacherReq teacherReq) {
    ...
    public ResponseEntity<StudentDto> recommend(@RequestBody RecommendReq recommendReq) {
    ...
    public ResponseEntity<LectureDto> lectureInsert(@RequestBody LectureReq lectureReq) {
    ...
    public ResponseEntity<LectureDto> lectureClose(@RequestBody CloseReq closeReq) {
